      ...
      <div class = "grid grid-cols-12 gap-4 p-8">
        <div class = "col-span-3 max-md:hidden">
          <nav class = "overflow-auto h-screen sticky top-16 border-r-8 py-8" >
            <ul>
              <li>
                <div class = "class-overv cursor-pointer text-2xl" ref = "overvButton">Overview</div>
              </li>
              <li>
                <div class = "class-dra cursor-pointer text-2xl" ref = "draButton">Dr Rachit Aggarwal</div>
              </li>
              <li>
                <div class = "class-ddc cursor-pointer text-2xl" ref = "ddcButton">Dr Dipshika Chakravorty</div>
              </li>
              <li>
                <div class = "class-nifr cursor-pointer text-2xl" ref = "nifrButton">National Institute for Research in Reproductive and Child Health</div>
              </li>
              <li>
                <div class = "class-nv cursor-pointer text-2xl" ref = "nvButton">Nimi Vashi</div>
              </li>
              <li>
                <div class = "class-bbc cursor-pointer text-2xl" ref = "bbcButton">Bangalore Bioinnovation Centre</div>
              </li>

              <li>
                <div class = "class-s cursor-pointer text-2xl" ref = "sButton">Samarth</div>
              </li>
              <li>
                <div class = "class-dsrgs cursor-pointer text-2xl" ref = "dsrgsButton">Dr Subba Rao Gangi Setty</div>
              </li>
              <li>
                <div class = "class-dgr cursor-pointer text-2xl" ref = "dgrButton">Dr Graca Raposo</div>
              </li>
              <li>
                <div class = "class-dsj cursor-pointer text-2xl" ref = "dsjButton">Dr Siddarth Jhunjhunwala</div>
              </li>
              <li>
                <div class = "class-dmka cursor-pointer text-2xl" ref = "dmkaButton">Dr MK Ammembal</div>
              </li>

              <li>
                <div class = "class-val cursor-pointer text-2xl" ref = "valButton">Vinod and Lavanya</div>
              </li>
              <li>
                <div class = "class-dcac cursor-pointer text-2xl" ref = "dcacButton">Dr Christian Andrew Choe</div>
              </li>
              <li>
                <div class = "class-as cursor-pointer text-2xl" ref = "asButton">Amar Singh</div>
              </li>
              <li>
                <div class = "class-nb cursor-pointer text-2xl" ref = "nbButton">Nisha Barge</div>
              </li>
              <li>
                <div class = "class-rro cursor-pointer text-2xl" ref = "rroButton">RR Ojha from QUAXON</div>
              </li>
              <li>
                <div class = "class-nab cursor-pointer text-2xl" ref = "nabButton">Nandika Bhattacharya</div>
              </li>
              <li>
                <div class = "class-vaask cursor-pointer text-2xl" ref = "vaaskButton">Vinayak Annapure and Shreya Kulkarni</div>
              </li>
              <li>
                <div class = "class-drv cursor-pointer text-2xl" ref = "drvButton">Dr Raghavan Varadarajan</div>
              </li>
              <li>
                <div class = "class-das cursor-pointer text-2xl" ref = "dasButton">Dr Ajay Singh</div>
              </li>
              <li>
                <div class = "class-drb cursor-pointer text-2xl" ref = "drbButton">Dr Ramray Bhat</div>
              </li>
              <li>
                <div class = "class-dpd cursor-pointer text-2xl" ref = "dpdButton">Dr Prajakta Dandekar</div>
              </li>
              <li>
                <div class = "class-jk cursor-pointer text-2xl" ref = "jkButton">J Konnowich</div>
              </li>
              <li>
                <div class = "class-es cursor-pointer text-2xl" ref = "esButton">Education Secretaries</div>
              </li>
              <li>
                <div class = "class-ddip cursor-pointer text-2xl" ref = "ddipButton">DD Interview Panel</div>
              </li>
              <li>
                <div class = "class-dlb cursor-pointer text-2xl" ref = "dlbButton">Dr Lavanya Bhagavatula</div>
              </li>
              <li>
                <div class = "class-dsr cursor-pointer text-2xl" ref = "dsrButton">Dr Shilpa Rao</div>
              </li>
              <li>
                <div class = "class-dam cursor-pointer text-2xl" ref = "damButton">Dr Abhishek Mangeshikar</div>
              </li>
...
<figure class="max-w-lg relative relative left-2/4 -translate-x-2/4">
  <img class="h-auto w-1/2 rounded-lg" src="https://static.igem.wiki/teams/4829/wiki/awards/ihp/rachit.png " alt="image description">
...
<figure class="max-w-lg relative relative left-2/4 -translate-x-2/4">
  <img class="h-auto w-1/2 rounded-lg" src="https://static.igem.wiki/teams/4829/wiki/awards/ihp/dipshika.jpg  " alt="image description">
  <figcaption class="mt-2 text-sm text-gray-500 dark:text-gray-400">Image caption</figcaption>
</figure> 
...
<br />
https://static.igem.wiki/teams/4829/wiki/logo/metramorpheus.png 
<br />
...
<figure class="max-w-lg relative relative left-2/4 -translate-x-2/4">
  <img class="h-auto w-1/2 rounded-lg" src="https://static.igem.wiki/teams/4829/wiki/awards/ihp/oldppt.jpg " alt="image description">
  <figcaption class="mt-2 text-sm text-gray-500 dark:text-gray-400">Image caption</figcaption>
</figure> 
<br />
...
<figure class="max-w-lg relative relative left-2/4 -translate-x-2/4">
  <img class="h-auto w-1/2 rounded-lg" src="https://static.igem.wiki/teams/4829/wiki/awards/ihp/newppt.jpg" alt="image description">
  <figcaption class="mt-2 text-sm text-gray-500 dark:text-gray-400">Image caption</figcaption>
</figure> 
<br /><br />
...
<figure class="max-w-lg relative relative left-2/4 -translate-x-2/4">
  <img class="h-auto w-1/2 rounded-lg" src="https://static.igem.wiki/teams/4829/wiki/awards/ihp/nimi.jpeg " alt="image description">
  <figcaption class="mt-2 text-sm text-gray-500 dark:text-gray-400">Image caption</figcaption>
</figure> 
 <br />
...
<figure class="max-w-lg relative relative left-2/4 -translate-x-2/4">
  <img class="h-auto w-1/2 rounded-lg" src="https://static.igem.wiki/teams/4829/wiki/awards/ihp/jitendra-bioinno.jpeg " alt="image description">
  <figcaption class="mt-2 text-sm text-gray-500 dark:text-gray-400">Image caption</figcaption>
</figure> 
 
<br />
https://media.licdn.com/dms/image/C4E03AQFgAZpR65LQYA/profile-displayphoto-shrink_800_800/0/1517714151886?e=1702512000&v=beta&t=KgpHMy8avu99_A5IABknKAe--AZIRII1cSQ-jxzLfNg 
...
https://media.licdn.com/dms/image/D5603AQEtLPiJWYw0Uw/profile-displayphoto-shrink_400_400/0/1677129910869?e=1702512000&v=beta&t=Ela1ks8I__-P-8CIlzfHsa0jBbva0Pj2kGXSXNRPLzY 

<figure class="max-w-lg relative relative left-2/4 -translate-x-2/4">
  <img class="h-auto w-1/2 rounded-lg" src="https://static.igem.wiki/teams/4829/wiki/awards/ihp/rita-shree-bioinno.jpeg " alt="image description">
  <figcaption class="mt-2 text-sm text-gray-500 dark:text-gray-400">Image caption</figcaption>
</figure> 
...
<figure class="max-w-lg relative relative left-2/4 -translate-x-2/4">
  <img class="h-auto w-1/2 rounded-lg" src="https://static.igem.wiki/teams/4829/wiki/awards/ihp/samarth.jpeg" alt="image description">
  <figcaption class="mt-2 text-sm text-gray-500 dark:text-gray-400">Image caption</figcaption>
</figure> 
...
Action: Since then, we have tried to include more visualisations in our presentation, using posters, biorenders, etc. and minimise the text part. Not only did it help in explaining the project better to our stakeholders, but also helped a lot in our education efforts while presenting to young students. 
 ...
 <figure class="max-w-lg relative relative left-2/4 -translate-x-2/4">
  <img class="h-auto w-1/2 rounded-lg" src="https://static.igem.wiki/teams/4829/wiki/awards/ihp/subba.jpg" alt="image description">
  <figcaption class="mt-2 text-sm text-gray-500 dark:text-gray-400">Image caption</figcaption>
</figure> 
<br />
...
<figure class="max-w-lg relative relative left-2/4 -translate-x-2/4">
  <img class="h-auto w-1/2 rounded-lg" src="https://static.igem.wiki/teams/4829/wiki/awards/ihp/graca.jpg " alt="image description">
  <figcaption class="mt-2 text-sm text-gray-500 dark:text-gray-400">Image caption</figcaption>
</figure> 
 <br />
...
<figure class="max-w-lg relative relative left-2/4 -translate-x-2/4">
  <img class="h-auto w-1/2 rounded-lg" src="https://static.igem.wiki/teams/4829/wiki/awards/ihp/siddharth.jpg " alt="image description">
  <figcaption class="mt-2 text-sm text-gray-500 dark:text-gray-400">Image caption</figcaption>
</figure> 
...
<figure class="max-w-lg relative relative left-2/4 -translate-x-2/4">
  <img class="h-auto w-1/2 rounded-lg" src="https://static.igem.wiki/teams/4829/wiki/awards/ihp/mkammembal.png " alt="image description">
  <figcaption class="mt-2 text-sm text-gray-500 dark:text-gray-400">Image caption</figcaption>
</figure> 
...
<figure class="max-w-lg relative relative left-2/4 -translate-x-2/4">
  <img class="h-auto w-1/2 rounded-lg" src="https://static.igem.wiki/teams/4829/wiki/awards/ihp/vinod.jpeg " alt="image description">
  <figcaption class="mt-2 text-sm text-gray-500 dark:text-gray-400">Image caption</figcaption>
</figure> 
...
<figure class="max-w-lg relative relative left-2/4 -translate-x-2/4">
  <img class="h-auto w-1/2 rounded-lg" src="https://static.igem.wiki/teams/4829/wiki/awards/ihp/western-with-tg1-copy.jpg  " alt="image description">
  <figcaption class="mt-2 text-sm text-gray-500 dark:text-gray-400">Image caption</figcaption>
</figure> 
<br />
^TG1 
...
<figure class="max-w-lg relative relative left-2/4 -translate-x-2/4">
  <img class="h-auto w-1/2 rounded-lg" src="https://static.igem.wiki/teams/4829/wiki/awards/ihp/western-with-bl21-copy.jpg" alt="image description">
  <figcaption class="mt-2 text-sm text-gray-500 dark:text-gray-400">Image caption</figcaption>
</figure> 
<br />
^BL21 
...
<figure class="max-w-lg relative relative left-2/4 -translate-x-2/4">
  <img class="h-auto w-1/2 rounded-lg" src="https://static.igem.wiki/teams/4829/wiki/awards/ihp/christian-andrew.jpg " alt="image description">
  <figcaption class="mt-2 text-sm text-gray-500 dark:text-gray-400">Image caption</figcaption>
</figure> 
...
Action: Ribotree helped us a lot in optimising our mRNA, details of which are on the Modelling page. Also, we helped in fixing multiple bugs in their software and its dependencies. We are now creating a Docker Image to allow easy installation of RiboTree and reproducibility of results. We plan to get back to Das Lab and suggest they provide this image in their distribution. 
 ...
 <figure class="max-w-lg relative relative left-2/4 -translate-x-2/4">
  <img class="h-auto w-1/2 rounded-lg" src="https://static.igem.wiki/teams/4829/wiki/awards/ihp/amar-singh.jpeg " alt="image description">
  <figcaption class="mt-2 text-sm text-gray-500 dark:text-gray-400">Image caption</figcaption>
</figure> 
...
Action: We used GRAMM and it became the most important software in our docking analysis. Our results can be seen on the Modelling page. 
 ...
 <figure class="max-w-lg relative relative left-2/4 -translate-x-2/4">
  <img class="h-auto w-1/2 rounded-lg" src="https://static.igem.wiki/teams/4829/wiki/awards/ihp/nisha-barge.jpeg " alt="image description">
  <figcaption class="mt-2 text-sm text-gray-500 dark:text-gray-400">Image caption</figcaption>
</figure> 
<br />
...
Action: Much of our dry lab was based on these fundamental suggestions. We implemented her advice partwise, forming various subteams to focus on each part. For further information on the incorporation of these ideas, check our Modelling page. 
 ...
 <figure class="max-w-lg relative relative left-2/4 -translate-x-2/4">
  <img class="h-auto w-1/2 rounded-lg" src="https://static.igem.wiki/teams/4829/wiki/awards/ihp/quaxon.jpg " alt="image description">
  <figcaption class="mt-2 text-sm text-gray-500 dark:text-gray-400">Image caption</figcaption>
</figure> 
...
<figure class="max-w-lg relative relative left-2/4 -translate-x-2/4">
  <img class="h-auto w-1/2 rounded-lg" src="https://static.igem.wiki/teams/4829/wiki/awards/ihp/nandika1.jpg " alt="image description">
  <figcaption class="mt-2 text-sm text-gray-500 dark:text-gray-400">Image caption</figcaption>
</figure> 
...
<figure class="max-w-lg relative relative left-2/4 -translate-x-2/4">
  <img class="h-auto w-1/2 rounded-lg" src="https://static.igem.wiki/teams/4829/wiki/awards/ihp/shreya.jpeg " alt="image description">
  <figcaption class="mt-2 text-sm text-gray-500 dark:text-gray-400">Image caption</figcaption>
</figure> 
...
<figure class="max-w-lg relative relative left-2/4 -translate-x-2/4">
  <img class="h-auto w-1/2 rounded-lg" src="https://static.igem.wiki/teams/4829/wiki/awards/ihp/vinayak.png " alt="image description">
  <figcaption class="mt-2 text-sm text-gray-500 dark:text-gray-400">Image caption</figcaption>
</figure> 
<br />
...
<figure class="max-w-lg relative relative left-2/4 -translate-x-2/4">
  <img class="h-auto w-1/2 rounded-lg" src="https://static.igem.wiki/teams/4829/wiki/awards/ihp/raghavan.jpeg  " alt="image description">
  <figcaption class="mt-2 text-sm text-gray-500 dark:text-gray-400">Image caption</figcaption>
</figure> 
...
<figure class="max-w-lg relative relative left-2/4 -translate-x-2/4">
  <img class="h-auto w-1/2 rounded-lg" src="https://static.igem.wiki/teams/4829/wiki/awards/ihp/ajay-singh.jpeg " alt="image description">
  <figcaption class="mt-2 text-sm text-gray-500 dark:text-gray-400">Image caption</figcaption>
</figure> 
...
<figure class="max-w-lg relative relative left-2/4 -translate-x-2/4">
  <img class="h-auto w-1/2 rounded-lg" src="https://static.igem.wiki/teams/4829/wiki/awards/ihp/ramray.jpg  " alt="image description">
  <figcaption class="mt-2 text-sm text-gray-500 dark:text-gray-400">Image caption</figcaption>
</figure> 
...
<figure class="max-w-lg relative relative left-2/4 -translate-x-2/4">
  <img class="h-auto w-1/2 rounded-lg" src="https://static.igem.wiki/teams/4829/wiki/awards/ihp/j-konnowich.png " alt="image description">
  <figcaption class="mt-2 text-sm text-gray-500 dark:text-gray-400">Image caption</figcaption>
</figure> 
...
Action: His visualisations helped us understand the mechanism of 2 channel flow better, which we incorporated into our model. We also realised the business scope of OoCs, and the ease with which we can expand in it, specially in an untapped market like India. We included this in the entrepreneurial aspect of our project. 
          ...
          <section id = "es" ref = "es">
            ...
            <h2>
              ...
              <figure class="max-w-lg relative relative left-2/4 -translate-x-2/4">
  <img class="h-auto w-1/2 rounded-lg" src="https://static.igem.wiki/teams/4829/wiki/awards/education/education-secretaries/govt2.jpg" alt="image description">
  <figcaption class="mt-2 text-sm text-gray-500 dark:text-gray-400">Image caption</figcaption>
</figure> 
...
<br />
 ...
 <figure class="max-w-lg relative relative left-2/4 -translate-x-2/4">
  <img class="h-auto w-1/2 rounded-lg" src="https://static.igem.wiki/teams/4829/wiki/awards/education/education-secretaries/govt1.jpg " alt="image description">
  <figcaption class="mt-2 text-sm text-gray-500 dark:text-gray-400">Image caption</figcaption>
</figure> 
...
<figure class="max-w-lg relative relative left-2/4 -translate-x-2/4">
  <img class="h-auto w-1/2 rounded-lg" src="https://static.igem.wiki/teams/4829/wiki/awards/education/doordarshan/dd.jpg " alt="image description">
  <figcaption class="mt-2 text-sm text-gray-500 dark:text-gray-400">Image caption</figcaption>
</figure> 
...
<figure class="max-w-lg relative relative left-2/4 -translate-x-2/4">
  <img class="h-auto w-1/2 rounded-lg" src="https://static.igem.wiki/teams/4829/wiki/awards/ihp/lavanya-bhargavatula.jpg  " alt="image description">
  <figcaption class="mt-2 text-sm text-gray-500 dark:text-gray-400">Image caption</figcaption>
</figure> 
 <br />
...
<figure class="max-w-lg relative relative left-2/4 -translate-x-2/4">
  <img class="h-auto w-1/2 rounded-lg" src="https://static.igem.wiki/teams/4829/wiki/awards/ihp/shilpa.jpg  " alt="image description">
  <figcaption class="mt-2 text-sm text-gray-500 dark:text-gray-400">Image caption</figcaption>
</figure> 
...
<figure class="max-w-lg relative relative left-2/4 -translate-x-2/4">
  <img class="h-auto w-1/2 rounded-lg" src="https://static.igem.wiki/teams/4829/wiki/awards/ihp/abhishek.jpg " alt="image description">
  <figcaption class="mt-2 text-sm text-gray-500 dark:text-gray-400">Image caption</figcaption>
</figure> 
